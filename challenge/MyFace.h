...
namespace myface
{
    ...
    enum CLA { CL_NORM_L2,CL_NORM_L2SQR,CL_NORM_L1,CL_NORM_HAM,CL_PSNR,CL_HIST_HELL,CL_HIST_ISEC,CL_SVM,CL_SVMMulti,CL_COSINE,CL_FISHER,CL_MAX };
    enum PRE { PRE_none,PRE_eqhist,PRE_clahe,PRE_retina,PRE_tantriggs,PRE_crop,PRE_MAX };

    static const char *EXS[] = { "Pixels","Lbp","TPLbp","FPLbp","MTS","GaborLbp","Dct","OrbGrid","SiftGrid",0 };
    static const char *CLS[] = { "NORM_L2","NORM_LSQR","NORM_L1","NORM_HAM","PSNR","HIST_HELL","HIST_ISEC","SVM","SVMMulti","COSINE","FISHER",0 };
