...
namespace myface
{
    ...
    enum CLA { CL_NORM_L2,CL_NORM_L2SQR,CL_NORM_L1,CL_NORM_HAM,CL_HIST_HELL,CL_HIST_CHI,CL_SVM,CL_SVMMulti,CL_COSINE,CL_FISHER,CL_MAX };
    ...
    static const char *CLS[] = { "NORM_L2","NORM_LSQR","NORM_L1","NORM_HAM","HIST_HELL","HIST_CHI","SVM","SVMMulti","COSINE","FISHER",0 };
