...
namespace myface
{
    enum EXT { EXT_Pixels,EXT_Lbp,EXT_Lbpu,EXT_TPLbp,EXT_FPLbp,EXT_MTS,EXT_GaborLbp,EXT_Dct,EXT_OrbGrid,EXT_SiftGrid,EXT_MAX };
    enum CLA { CL_NORM_L2,CL_NORM_L2SQR,CL_NORM_L1,CL_NORM_HAM,CL_HIST_HELL,CL_HIST_CHI,CL_SVM,CL_EM,CL_COSINE,CL_FISHER,CL_MAX };
    enum PRE { PRE_none,PRE_eqhist,PRE_clahe,PRE_retina,PRE_tantriggs,PRE_crop,PRE_MAX };

    static const char *EXS[] = { "Pixels","Lbp","Lbpu","TPLbp","FPLbp","MTS","GaborLbp","Dct","OrbGrid","SiftGrid",0 };
    static const char *CLS[] = { "NORM_L2","NORM_LSQR","NORM_L1","NORM_HAM","HIST_HELL","HIST_CHI","SVM","EM","COSINE","FISHER",0 };
