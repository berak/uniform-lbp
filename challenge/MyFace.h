...
namespace myface {
    ...
    static const char *EXS[] = { "EXT_Pixels","EXT_Lbp","EXT_FPLbp","EXT_MTS","EXT_GaborLbp","EXT_Dct","EXT_OrbGrid","EXT_SiftGrid",0 };
    static const char *CLS[] = { "CL_NORM_L2","CL_NORM_L1","CL_NORM_HAM","CL_HIST_HELL","CL_HIST_ISEC","CL_SVM","CL_SVMMulti","CL_COSINE","CL_FISHER",0 };
    static const char *PPS[] = { "none","eqhist","clahe","retina","PRE_tantriggs","crop",0 };
}
