...
int uni_dn_r1[256] = {
    0,1,2,3,4,4,5,6,7,7,7,3,8,8,9,10,11,11,11,3,11,58,5,6,12,12,12,58,13,13,14,15,16,
    16,16,3,16,58,5,6,16,58,58,58,8,58,9,10,17,17,17,58,17,58,58,58,18,18,18,58,19,
    19,20,21,22,22,22,3,22,58,5,6,22,58,58,58,8,58,9,10,22,58,58,58,58,58,58,58,12,58,
    58,58,13,58,14,15,23,23,23,58,23,58,58,58,23,58,58,58,58,58,58,58,24,24,24,58,
    24,58,58,58,25,25,25,58,26,26,27,28,29,30,29,31,29,30,5,32,29,30,58,31,8,58,9,33,
    29,30,58,31,58,58,58,32,12,58,58,58,13,58,14,34,29,30,58,31,58,58,58,32,58,58,58,
    58,58,58,58,33,17,58,58,58,58,58,58,58,18,58,58,58,19,58,20,35,36,37,36,38,36,
    37,58,39,36,37,58,38,58,58,58,40,36,37,58,38,58,58,58,39,58,58,58,58,58,58,58,41,
    42,43,42,44,42,43,58,45,42,43,58,44,58,58,58,46,47,48,47,49,47,48,58,50,51,52,51,
    53,54,55,56,57
};
int uni_up_r2[256] = {
    0,1,2,3,4,6,5,6,7,58,9,10,8,10,9,10,11,58,58,58,13,58,14,15,12,58,14,15,13,15,14,
...
inline void elbp_(InputArray _src, OutputArray _dst, int radius, int neighbors, bool uniform, std::vector<int> lookup) {
    ...
    if ( uniform ) { // replace content of dst with its resp. lookup value
        for ( size_t i=0; i<dst.total(); i++ ) {
            dst.at<int>(i) = uni2[ dst.at<int>(i) ];
