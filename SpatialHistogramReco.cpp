...
void SpatialHistogramReco::load(const FileStorage& fs) {
    fs["grid_x"] >> _grid_x;
    fs["grid_y"] >> _grid_y;
    //read matrices
...
void SpatialHistogramReco::save(FileStorage& fs) const {
    fs << "grid_x" << _grid_x;
    fs << "grid_y" << _grid_y;
    // write matrices
...
void SpatialHistogramReco::train(InputArrayOfArrays _in_src, InputArray _in_labels) {
    this->train(_in_src, _in_labels, false);
}

void SpatialHistogramReco::update(InputArrayOfArrays _in_src, InputArray _in_labels) {
...
int SpatialHistogramReco::predict(InputArray _src) const {
    int label;
    double dummy;
